...
import { LoginProps, User } from '../../../../types/auth';
...
const Login: React.FC<LoginProps> = ({ onLogin }) => {
  ...
  const [version, setVersion] = useState<'defense' | 'civilian'>('defense');
  ...
  const handleVersionChange = (event: any) => {
    setVersion(event.target.value as 'defense' | 'civilian');
  };
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      setError('Production login not implemented');
    } catch (err) {
